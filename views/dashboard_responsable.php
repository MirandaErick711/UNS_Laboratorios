...
<head>
    ...
    <title>
        Panel Responsable | Sistema de Reservas UNS
    </title>
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="mb-4">
        ...
        <small class="text-muted">
            ...
            Consulta el estado de los laboratorios y gestiona
            las reservas.
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table
                    class="table table-hover align-middle d-none"
                    id="tablaPendientes"
                >
