...
<head>
    ...
    <style>
        ...
        #tablaPendientes tbody tr { transition: opacity .3s ease, transform .3s ease; }
        .fila-procesando { opacity: .4; pointer-events: none; }
        #estadoVacio { display: none; }
    </style>
</head>
<body class="bg-light">
...
<div class="container-fluid px-4 py-4">
    <div class="mb-4">
        <h4 class="fw-bold mb-0" style="color: var(--uns-rojo);">
            <i class="bi bi-speedometer2 me-2"></i>Panel del Responsable
        </h4>
            ...
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <small class="text-muted">Laboratorios operativos</small>
                            <h3 class="fw-bold mb-0" id="indicadorOperativos">-</h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" id="indicadorMantenimiento">-</h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0" id="indicadorPendientes">-</h3>
                        </div>
        ...
        <div class="col-xl col-md-6">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <small class="text-muted">Aprobadas este mes</small>
                            <h3 class="fw-bold mb-0" id="indicadorAprobadas">-</h3>
                        </div>
                        <div class="fs-2 text-success">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white">
            <h5 class="fw-bold mb-0" style="color: var(--uns-rojo);">
                <i class="bi bi-bar-chart me-2"></i>Uso de laboratorios este mes
            </h5>
            <small class="text-muted">
        ...
        <div class="card-body">
            ...
            <div id="tablaUsoLaboratorios" class="table-responsive d-none">
                <table class="table table-hover align-middle mb-0">
                    <thead>
                        <tr class="table-light">
                            <th>Laboratorio</th>
                            <th>Estado</th>
                            <th class="text-center">Reservas aprobadas</th>
                        </tr>
                    </thead>
                    <tbody id="cuerpoUsoLaboratorios"></tbody>
                </table>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="cargandoAuditoria" class="text-center py-4">
                        <div class="spinner-border" style="color: var(--uns-rojo);" role="status"></div>
                        <p class="text-muted mt-2 mb-0">Cargando auditoría...</p>
                    </div>

                    <div id="sinAuditoria" class="text-center text-muted py-4 d-none">
                        <i class="bi bi-clock-history fs-2"></i>
                        <p class="mt-2 mb-0">No hay registros de auditoría.</p>
                    </div>

                    <div id="contenedorAuditoria" class="table-responsive d-none">
